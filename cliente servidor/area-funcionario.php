...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="area-funcionario.php">Inicio</a>
                </li>
                <li class="nav-item active">
    ...
    <div class="logado">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 style="color: white;">Funcionário, seja bem-vindo!</h1>
                    <div id="tabela-perfil">
                        <table class="table table-bordered table-dark">
                            <th colspan="2">
                            <button onclick="location.href='?page=editar-perfil'" type="button" class="btn btn-outline-light">
                                    <div id="foto-perfil">
